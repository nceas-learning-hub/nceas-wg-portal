...
Next, **you'll need to install an <u>i</u>ntegrated <u>d</u>evelopment <u>e</u>nvironment** or "IDE". This will allow you to write code and use Git with a neat, easy-to-use interface. There are a number of IDEs that exist but RStudio or Positron are reasonable 'first choices' for those coding primarily in R
