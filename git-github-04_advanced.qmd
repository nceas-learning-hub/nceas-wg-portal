---
title: "Git & GitHub: Advanced Features"
---
...
![](images/git-github-04_advanced/positron-01_start.png){fig-alt="Screen capture of Positron" .lightbox}
...
![](images/git-github-04_advanced/positron-02_new-branch.png){fig-alt="Screenshot of the dropdown menu in Positron for creating a new branch" fig-align="center" width="80%" .lightbox}
...
![](images/git-github-04_advanced/positron-03_branch-details.png){fig-alt="Screenshot of the field in Positron where you type new branch names" .lightbox}
...
![](images/git-github-04_advanced/positron-04_publish-branch.png){fig-alt="Screenshot of the Positron 'source control' pane where the 'Publish Branch' button is active" fig-align="center" width="80%" .lightbox}
...
![](images/git-github-04_advanced/positron-05_published.png){fig-alt="Screenshot of the Positron 'source control' pane after a new branch has been published" fig-align="center" width="80%" .lightbox}
...
![](images/git-github-04_advanced/rstudio-01_start.png){fig-alt="Screen capture of RStudio" .lightbox}
...
![](images/git-github-04_advanced/rstudio-02_branch-details.png){fig-alt="Screenshot of the menu that opens when you click the purple 'create branch' button in RStudio. Includes a text field for the branch name as well as a some other checkboxes/options (that can be safely left at their default settings in many cases)" fig-align="center" width="50%" .lightbox}
...
![](images/git-github-04_advanced/rstudio-03_branch-message.png){fig-alt="Screenshot of the text returned when you create a branch in RStudio" fig-align="center" width="80%" .lightbox}
...
![](images/git-github-04_advanced/github-01_pr-button.png){fig-alt="Screenshot of a repository in GitHub where the 'compare and pull request' button is being offered because GitHub detected a push in the branch" fig-align="center" width="80%" .lightbox}
...
![](images/git-github-04_advanced/github-02_pr-details.png){fig-alt="Screenshot of GitHub when you open a pull request and are prompted to give it a title and description" .lightbox}
...
![](images/git-github-04_advanced/github-03_pr-open.png){fig-alt="Screenshot of an open pull request on GitHub" .lightbox}
...
![](images/git-github-04_advanced/github-04_pr-merge-message.png){fig-alt="Screenshot of the menu that opens on GitHub when you click 'merge pull request' where you are prompted to add an optional description before clicking 'confirm merge'" .lightbox}
...
![](images/git-github-04_advanced/github-05_pr-merged.png){fig-alt="Screenshot of a closed pull request on GitHub with a 'delete branch' button provided" .lightbox}
...
![](images/git-github-04_advanced/github-06_pr-delete-branch.png){fig-alt="Screenshot of a pull request on GitHub after the 'delete branch' button has been clicked and replaced by a 'restore branch' button" .lightbox}
...
![](images/git-github-04_advanced/github-07_repo-home.png){fig-alt="Screenshot of a the home page of a GitHub repository where the most recent commit matches the pull request commit message from an earlier screen capture" .lightbox}
...
![](images/git-github-04_advanced/post-branch_positron-01_switch.png){fig-alt="Screenshot of the Git operations dropdown menu in Positron with the 'checkout to...' menu highlighted" fig-align="center" width="50%" .lightbox}
...
![](images/git-github-04_advanced/post-branch_positron-02_switch-dest.png){fig-alt="Screenshot of the Git operations dropdown menu in Positron" fig-align="center" width="80%" .lightbox}
...
![](images/git-github-04_advanced/post-branch_positron-03_pull.png){fig-alt="Screenshot of the Git operations dropdown menu in Positron with the 'pull' menu highlighted" fig-align="center" width="50%" .lightbox}
...
![](images/git-github-04_advanced/post-branch_positron-04_success.png){fig-alt="Screenshot of the branch diagram in Positron's source control menu" fig-align="center" width="50%" .lightbox}
...
![](images/git-github-04_advanced/post-branch_rstudio-01_switch.png){fig-alt="Screenshot of the Git branch dropdown menu in RStudio" fig-align="center" width="50%" .lightbox}
...
![](images/git-github-04_advanced/post-branch_rstudio-02_switch-message.png){fig-alt="Screenshot of the Git message in RStudio when switching branches" fig-align="center" width="80%" .lightbox}
...
![](images/git-github-04_advanced/post-branch_rstudio-03_pull-main.png){fig-alt="Screenshot of the Git message in RStudio when switching branches" fig-align="center" width="80%" .lightbox}
...
![](images/git-github-04_advanced/post-branch_positron-05_confirm-prune.png){fig-alt="Screenshot of the Git branch dropdown menu in Positron" fig-align="center" width="80%" .lightbox}
...
![](images/git-github-04_advanced/post-branch_rstudio-04_confirm-prune.png){fig-alt="Screenshot of the Git branch dropdown menu in RStudio" fig-align="center" width="50%" .lightbox}
...
![](images/git-github-04_advanced/git-fork-workflow.png){fig-alt="Graphic of the workflow when using forks. Begins by forking someone else's repository then working in your fork as you normally would" fig-align="center" width="75%" .lightbox}
...
![](images/git-github-04_advanced/forks-1-start.png){fig-alt="Screenshot of the top of a GitHub repository including the 'fork' button in the top right (in-line with the name of the repository)" .lightbox}
...
![](images/git-github-04_advanced/forks-2-name-fork.png){fig-alt="Screenshot of the GitHub interface for making a fork (where the repository can be renamed and have a description added)" .lightbox}
...
![](images/git-github-04_advanced/forks-3-fork-landing-page.png){fig-alt="Screenshot of the forked repository owned by a different owner than the original repository" .lightbox}
